...
uniq(names, (uniqArr) => {
console.log(`The new names array with all the duplicat items removed is ${uniqArr}`)
});
...
const each = (arr, callBack) => {
  arr.forEach((name, index) => {
    return callBack(name,index)
  })
}

each(names, (name, index) => {
  console.log(`The item at index ${index} is ${name}.`)
})
...
// const addTen = (num2) => num1 + num2
// addTen inherits the 10 from the parent (addingFactory) after it initalized and sent the 10 to addingFactory which input 10 into addingFactory and returned (num2) => 10 + num2 to addTen
